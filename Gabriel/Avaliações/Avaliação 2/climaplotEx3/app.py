...
from .manipulacaoDeDados import ManipulacaoDeDados
from .analiseDeDados import AnaliseDeDados
...
class App(tk.Tk):
    ...
    def botaoAnoClick(self,anoLink):
        ManipulacaoDeDados.donwloadCSV(anoLink,self._path)
        self._ano.set(anoLink["ano"])
        estacoes = ManipulacaoDeDados.getEstacoes(self._ano.get(),self._path)
